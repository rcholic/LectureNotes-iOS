//
//  DemoDrawViewController.swift
//  MultiMediaNotes
//
//  Created by Guoliang Wang on 11/13/16.
...
class DemoDrawViewController: UIViewController {
    ...
    fileprivate func setupToolBar() {
        ...
        toolBar.undoButton?.addTarget(self, action: #selector(DemoDrawViewController.onClickUndoButton), for: .touchUpInside)
        toolBar.redoButton?.addTarget(self, action: #selector(DemoDrawViewController.onClickRedoButton), for: .touchUpInside)
        toolBar.loadButton?.addTarget(self, action: #selector(DemoDrawViewController.onClickLoadButton), for: .touchUpInside)
        toolBar.saveButton?.addTarget(self, action: #selector(DemoDrawViewController.onClickSaveButton), for: .touchUpInside)
        // default title is "Save"
        toolBar.saveButton?.setTitle("share", for: UIControlState())
        toolBar.clearButton?.addTarget(self, action: #selector(DemoDrawViewController.onClickClearButton), for: .touchUpInside)
...
extension DemoDrawViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
...
extension DemoDrawViewController: UIActionSheetDelegate
{
...
extension DemoDrawViewController: UIAlertViewDelegate
{
